...
import com.sasaki.splittrip.adapters.MemberAdapter;
...
public class MembersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (group != null) {
            adapter = new MemberAdapter(group.getMembers()); // O adapter deve exibir o saldo
    ...
    /**
     * Método público para atualizar a lista, essencial para exibir o saldo recalculado.
     */
